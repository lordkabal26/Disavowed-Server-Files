...
DZAI_heliList = [
	["UH1H_SMD_BLOPS_DIGI",5],
	["UH1H_SMD_BLOPS",5],
	["UH1H_SMD_UN",5],
	["UH1H_SMD_RACS_DIGI",5],
	["UH1H_SMD_RACS",5],
	["ffs_bf109_trop_sc250",5],
	["ffs_bf109_sc250",5],	
	["UH1H_DZ",5],
	["MH60S",5],
	["Ka137_MG_PMC",5],
...
DZAI_vehList = [
	["SUV_SMD_RACS_DIGI",5],
	["UralSalvage_TK_EP1",5],
	["WarfareSalvageTruck_INS",5],
	["V3S_Salvage_TK_GUE_EP1",5],
	["WarfareSalvageTruck_USMC",5],
	["MtvrSalvage_DES_EP1",5],
	["WarfareSalvageTruck_CDF",5],
	["WarfareSalvageTruck_RU",5],
	["LandRover_SMD_RACS_DIGI",5],
	["HMMWV_SMD_RACS_DIGI",5],
	["HMMWV_M2_SMD_RACS_DIGI",5],
	["BRDM2_HQ_TK_GUE_EP1",5],
	["BRDM2_HQ_Gue",5],
	["PRACS_HMMWV_AUN",5],
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_BanditTypes = ["MVD_Soldier", "MVD_Soldier_AT", "MVD_Soldier_GL", "MVD_Soldier_MG", "MVD_Soldier_Marksman", "MVD_Soldier_Sniper"];
