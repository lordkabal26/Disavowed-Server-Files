...
_rare_weapons_group = ["KSVK_DZE","AA12_PMC","BAF_AS50_scoped","M110_NVG_EP1","BAF_AS50_TWS","M107_DZ","BAF_LRR_scoped","m107"];

// Legendaries
_legend_group = ["PipeBomb","ItemHotwireKit","BAF_NLAW_Launcher","Javelin","MetisLauncher"];
_chainsaw_group = ["Chainsaw","ChainsawB","ChainsawG","ChainsawP"];
_gem_group = ["EvMoney","ItemObsidian","ItemCitrine","ItemTopaz","ItemRuby","ItemSapphire","ItemEmerald","ItemAmathyst"]; //You can use this if your server uses gems as currency
