...
CurrencyName = "Caps"; // If using single currency this is the currency display name.
...
Z_VehicleDistance = 80; // Max distance a vehicle can be sold or accessed from at a trader.
DZE_keepVehicleKey = true; // Keep the vehicle key when the vehicle is sold? (Useful on servers with the key changer mod)

DZE_PlotPole = [200,200];
...
ZSC_bankTraders = ["Functionary1_EP1_DZ","Damsel1"]; // Array of trader classnames that are available for banking (i.e RU_Functionary1)
