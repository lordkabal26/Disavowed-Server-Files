...
_MiscLarge = ["Land_Ind_TankSmall","Land_Misc_ConcBox_EP1","MAP_AirCond_big","MAP_AirCond_small","MAP_AirCondition_A","MAP_AirCondition_B","MAP_antenna_big_roof","MAP_antenna_small_roof","MAP_antenna_small_roof_1","MAP_bouda_plech","MAP_drevo_hromada","MAP_kasna_new","MAP_kulna","MAP_Misc_Greenhouse","MAP_Misc_Hutch","MAP_PowerGenerator","Pile_of_wood","MAP_Misc_WoodPile","MAP_Ladder","MAP_P_Ladder","MAP_LadderHalf","MAP_P_LadderLong","oilrig","Land_LHD_1","Land_LHD_2","Land_LHD_3","Land_LHD_4","Land_LHD_5","Land_LHD_6","Land_LHD_elev_R","Land_LHD_house_1","Land_LHD_house_2","MBG_Killhouse_1_InEditor","MBG_Killhouse_2_InEditor","MBG_Warehouse_InEditor","Land_aif_hotel_bio","mbg_brickhouse_01_EO","mbg_apartments_big_04_EO"];
...
_Tents = ["CDF_WarfareBFieldhHospital","USMC_WarfareBFieldhHospital","MAP_MASH","MAP_Stan","MAP_Stan_east","MAP_tent_east","MAP_tent_small_west","MAP_tent_west","MAP_tent2_west","BRDM2_HQ_TK_GUE_unfolded_EP1","M1130_HQ_unfolded_EP1","US_WarfareBBarracks_EP1","TK_GUE_WarfareBBarracks_EP1"];
_Towers = ["MAP_vez"];
_Garage = ["Land_MBG_Garage_Single_A","Land_MBG_Garage_Single_B","Land_MBG_Garage_Single_C","Land_MBG_Garage_Single_D"];
_Fuel = ["Land_A_FuelStation_Feed"];
_Mounted_Weapons =["M2StaticMG","SPG9_TK_INS_EP1","M252","KORD_high_UN_EP1","Stinger_Pod_US_EP1","DSHKM_CDF","ZU23_CDF","TOW_TriPod_US_EP1","M119","D30_TK_EP1"];
_Topaz = _Defenses + _Forts + _Tents + _Towers + _Garage + _fuel + _Mounted_Weapons;
