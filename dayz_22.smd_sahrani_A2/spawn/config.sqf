...
#define START_ITEMS "ItemMorphine","ItemBandage",3,"ItemPainkiller","ItemWaterbottle","FoodMRE"
class_public = [ // These are visible to anyone on the server
	[(localize "str_playerstats_hero")+" Lv3","gsc_eco_stalker_mask_camo","SurvivorWpink_DZ",[START_ITEMS,"RH_7Rnd_50_AE",4,"ItemMorphine"],["RH_Deagleg","ItemGPS"],"DZ_Backpack_EP1 ",[],[],0,25000,0,"MeleeHatchet","Binocular_Vector","ItemToolbox","ItemRadio","ItemEtool","ItemMatchbox","ItemCrowbar","NVGoggles"],
	[(localize "str_playerstats_hero")+" Lv2","US_Delta_Force_Marksman_EP1","SurvivorWsequishaD_DZ",[START_ITEMS,"RH_7Rnd_50_AE",3,"ItemMorphine"],["RH_Deagles","ItemGPS"],"DZ_CivilBackpack_EP1 ",[],[],0,10000,0,"MeleeHatchet","Binocular_Vector","ItemToolbox","ItemRadio","ItemEtool","ItemMatchbox","ItemCrowbar"],
	[(localize "str_playerstats_hero")+" Lv1","CZ_Special_Forces_GL_DES_EP1_DZ","SurvivorWsequisha_DZ",[START_ITEMS,"RH_7Rnd_50_AE",2,"ItemMorphine"],["RH_deagle","ItemGPS"],"DZ_GunBag_EP1 ",[],[],0,5000,0,"MeleeHatchet","Binocular_Vector","ItemToolbox","ItemRadio","ItemEtool","ItemMatchbox","ItemCrowbar"],
	[localize "str_playerstats_Police","pz_policeman","SurvivorWcombat_DZ",[START_ITEMS,"RH_6Rnd_357_Mag",2],["RH_python","ItemMap"],"DZ_British_ACU ",[],[],0,3000,0,"MeleeHatchet","Binoculars","ItemToolbox","ItemRadio","ItemEtool","ItemMatchbox"],
	[localize "str_playerstats_Doctor","pz_doctor","SurvivorWurban_DZ",[START_ITEMS,"RH_15Rnd_9x19_usp",3,"ItemMorphine"],["RH_p226","ItemMap"],"DZ_CompactPack_EP1 ",[],[],0,2000,0,"MeleeHatchet","Binoculars","ItemToolbox","ItemRadio","ItemEtool"],
	[localize "str_playerstats_survivor","Survivor3_DZ","SurvivorWdesert_DZ",[START_ITEMS,"RH_30Rnd_9x19_tec",4,"ItemMorphine"],["RH_tec9","ItemMap"],"DZ_ALICE_Pack_EP1 ",[],[],0,1000,0,"MeleeHatchet","Binoculars","ItemToolbox","ItemRadio"],
	[localize "str_playerstats_Bambi","pz_villager1","SurvivorW3_DZ",[START_ITEMS,"RH_8Rnd_45cal_m1911",2],["RH_m1911old","ItemMap"],"DZ_Czech_Vest_Puch ",[],[],0,0,0,"MeleeHatchet","Binoculars","ItemToolbox","ItemRadio"]
];
...
spawn_bodyCheck = 500; // If a player has a body within this distance of a spawn that spawn will be blocked. Set to -1 to disable.
