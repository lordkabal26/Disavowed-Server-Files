...
_servicePointClasses = [dayz_fuelpumparray;"FuelPump_DZ","Land_A_FuelStation_Feed","Land_Ind_FuelStation_Feed_EP1","Land_FuelStation_Feed_PMC","FuelStation","Land_ibr_FuelStation_Feed","Land_fuelstation_army","Land_fuelstation","land_fuelstation_w","Land_benzina_schnell","Land_benzina","Land_A_FuelStation_Build","Land_Ind_FuelStation_Build_EP1","Land_ibr_FuelStation_Build","Land_FuelStation_Build_PMC","Map_A_FuelStation_Feed"]; // service point classes, You can also use dayz_fuelpumparray by its self for all the default fuel pumps.
